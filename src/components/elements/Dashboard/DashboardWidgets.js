...
export const DashboardWidgets = () => {
    ...
    const [selectedFilterOption, setSelectedFilterOption] = useState("userID");
                ...
                <Paper elevation={20} style={paperFilterSelectorStyle}>
                    ...
                    <Box sx={containerFilterStyle}>
                        ...
                        <Button variant="contained" onClick={() => {
                            setSelectedFilterOption(FilteringOptions.balance)
                        }}>Balance</Button>
                        <Button variant="contained" onClick={() => {
                            setSelectedFilterOption(FilteringOptions.winCoefficient)
                        }}>WinCoefficient</Button>
                        <Button variant="contained" onClick={() => {
                            setSelectedFilterOption(FilteringOptions.fundsLost)
                        }}>FundsLost</Button>
                        <Button variant="contained" onClick={() => {
                            setSelectedFilterOption(FilteringOptions.fundsPayedOut)
                        }}>FundsPayedOut</Button>
                    </Box>
                    <br/>
                    <br/>
                    <Grid
                    ...
                    >
                        ...
                        <TableBody>
                            {
                                playerData.map((user: PlayerFullDTO) => {
                                        return (
