...
import {Button, FormControl, FormGroup, Input, InputLabel, Modal, styled, Typography} from '@mui/material';
            ...
            >
                <Box sx={style}>
                    ...
                    <FormControl sx={{marginBottom: 10, marginRight: 3}}>
                        ...
                        <Input onChange={(e) => onValueChange(e)} name='type' value={user.type} id="my-input"
                    ...
                    <FormControl sx={{marginBottom: 10, marginRight: 2}}>
                        ...
                        <Input onChange={(e) => onValueChange(e)} name='nationalIDNumber' value={user.nationalIDNumber}
                               id="my-input" aria-describedby="my-helper-text"/>
                    </FormControl>
                    <FormControl sx={{marginBottom: 10, marginRight: 2}}>
                    ...
                    <FormControl sx={{marginBottom: 10, marginRight: 2}}>
                        ...
                        <Input onChange={(e) => onValueChange(e)} name='surname' value={user.surname} id="my-input"
                               aria-describedby="my-helper-text"/>
                    </FormControl>
                    <FormControl>
                        <InputLabel htmlFor="my-input">Balance</InputLabel>
                        <Input onChange={(e) => onValueChange(e)} name='balance' value={user.balance} id="my-input"
                               aria-describedby="my-helper-text"/>
                    </FormControl>
                    <br/>
